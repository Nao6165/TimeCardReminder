...
1. 当アプリを起動。(タスクトレイに常駐します)
   ![タスクトレイ](https://user-images.githubusercontent.com/54632092/87239567-9931f200-c44b-11ea-8e4d-a388ac1111cb.png)
2. タスクトレイのアイコンを右クリックし、**設定**を選択。(設定画面が起動します)
   ![タスクトレイ２](https://user-images.githubusercontent.com/54632092/87239603-09d90e80-c44c-11ea-8fb6-c80fc334390e.png)
